...
class AppPortalSettings(BaseModel):
...
__app_portal_settings: AppPortalSettings | None = None
__app_env: AppEnv | None = None


def app_portal_settings():
    global __app_portal_settings

    if not __app_portal_settings:
        __app_portal_settings = AppPortalSettings()

    return __app_portal_settings
...
def app_env(
    ...
    global __app_env
    srv_settings = app_portal_settings()
